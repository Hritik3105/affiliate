...
headers={"Authorization": "Bearer cndAr1dqTYZEL627h1MWB2bShHUvjdj1"}
        ...
        if serializer.is_valid(raise_exception=True):
            ...
            if serializer2.is_valid(raise_exception=True):
                ...
                if response.ok:
                    ...
                    return Response({"error": "Influencer requirement did not match"},status=status.HTTP_201_CREATED)
...
class StripeConnectAccountView(APIView):
    def post(self, request):  
        ...
        return Response({'account_id': account_id},status=status.HTTP_201_CREATED)
